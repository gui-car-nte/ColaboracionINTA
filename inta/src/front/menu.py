...
class LeftFrame(ctk.CTkFrame):
    def __init__(self, parent, replace_frame_func, service):
    ...
    def show_all_tabs(self):
        ...
        calculate_frame_instance = CalculateFrame(
            self.tabview.tab("Calculations"), self.service
        )
        DistanceFrame(
